<div class="container">
    <div class="row">
        <ol class="breadcrumb crm-panel-right" style="margin-left: 0 !important;">
            <li>WSDesk E-Mail</li>
            <li id="breadcrump_section" class="active">Setup Guides</li>
        </ol>
            ...
            <div class="panel panel-default crm-panel">
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked" role="tablist">
                        <li class="active">
                            <a href="#email_support_tab" data-toggle="tab" class="email_support">Support Email</a>
                        </li>
                        <li>
                            <a href="#oauth_setup_tab" data-toggle="tab" class="oauth_setup">Google OAuth Setup</a>
                        </li>
                        <li>
                            <a href="#imap_setup_tab" data-toggle="tab" class="imap_setup">IMAP EMail Setup</a>
                        </li>
                    </ul>
                </div>
            </div>
