                ...
                <div class="panel-heading col-md-12">
                    <ul class="nav nav-tabs col-md-11 elaborate" role="tablist">
                        <li class="active all_tickets" role="presentation">
                            <a href="#all_tickets_tab" aria-controls="all" style="text-align: center;" data-toggle="tab" class="tab_a">
                                All Tickets
                            </a>
                        </li>
                    ...
                    <div class="col-md-1 nav-tabs">
                        <div class="pull-right side_bar">
                            <a href="#" class="add-ticket tab_a" style="text-align: center;" data-placement="bottom" data-toggle="tooltip" title="New Ticket" data-container="body">
                                <span class="glyphicon glyphicon-plus"></span>
                            </a>
                        </div>
                        <div class="pull-right">
                            <div class="input-group stylish-input-group" style="margin: 3px 5px;">
                                <input type="text" class="form-control" id="search_ticket_input"  placeholder="Search" data-placement="bottom" data-toggle="tooltip" title="Search Tickets" data-container="body">
