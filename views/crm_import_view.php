<div class="container">
    <div class="row">
        <ol class="breadcrumb crm-panel-right" style="margin-left: 0 !important;">
            <li>Import Tickets</li>
            <li id="breadcrump_section" class="active">From Zendesk</li>
        </ol>
            ...
            <div class="panel panel-default crm-panel">
                <div class="panel-body">
                    <ul class="nav nav-pills nav-stacked" role="tablist">
                        <li class="active">
                            <a href="#zendesk_import_tab" data-toggle="tab" class="zendesk_import">From Zendesk</a>
                        </li>
                    </ul>
                </div>
            </div>
